import os , sys,time, collections as c , math , pprint , itertools as it , operator as op , bisect as bs ,functools as fn
...
for _ in range(int(input())):
	...
	print( 'BOB' if cnt  % 2 == 0 or n <= 2 or cnt == 1 else 'ALICE') if s == s[::-1] else print('DRAW') if cnt == 2 and s[n//2] == '0' and n % 2 else print('ALICE')
